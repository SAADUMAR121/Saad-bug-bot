...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`TRUST ME I'M MORE THEN WHAT YOU THINK`).catch(_ => _)
        }
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.imgur.com/rmCgpTY.jpg',
...
`.trim()
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    text: `*Script:* script 😒 wa.me923323963788`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on Instagram @saadumar.650`,
                            thumbnailUrl: 'https://i.imgur.com/rmCgpTY.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
"sellerJid": "923323963788@s.whatsapp.net",
